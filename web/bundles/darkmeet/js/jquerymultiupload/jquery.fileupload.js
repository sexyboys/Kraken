    ...
    $.widget('blueimp.fileupload', {
        ...
        _initXHRData: function (options) {
            ...
            if (!multipart || options.blob) {
                ...
                if (!options.blob) {
                    // Non-chunked non-multipart uploads:
                    options.contentType = file.type;
                    options.data = file;
                } else if (!multipart) {
                    // Chunked non-multipart uploads:
        ...
        _chunkedUpload: function (options, testOnly) {
            ...
            // n is the number of blobs to uploads,
            // calculated via filesize, uploaded bytes and max chunk size:
            n = Math.ceil((fs - ub) / mcs);
            // The chunk uploads method accepting the chunk number as parameter:
            upload = function (i) {
                if (!i) {
                ...
                return upload(i -= 1).pipe(function () {
                    ...
                    jqXHR = ($.ajax(o) || that._getXHRPromise(false, o.context))
                        .done(function () {
                            // Create a progress event if uploads is done and
